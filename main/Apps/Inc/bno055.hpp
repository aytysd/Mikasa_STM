...
#ifndef NARALIB_SENSOR_BNO055_HPP_
#define NARALIB_SENSOR_BNO055_HPP_
...
public:
	...
	bool GetIsResetNeeded( void ){ return m_f_IsResetNeeded; };
	void SetIsResetNeeded( bool f ){ m_f_IsResetNeeded = f; };

private:
	I2C_HandleTypeDef *_hi2c;
	void getQuaternion( double* quaternion );
	virtual void calcEuler();


protected:
	double _euler[3] = { 0 };
	double _init_euler[3] = { 0 };

	bool m_f_IsResetNeeded = false;
...
#endif /* NARALIB_SENSOR_BNO055_HPP_ */
